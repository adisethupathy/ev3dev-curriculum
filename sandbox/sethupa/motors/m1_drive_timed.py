...
#     900 degrees / second  -->  traveled 46.2 inches  --> 9.24 inches / second (probably no faster than 800)
#
...
# DONEDO: 5. Write the code necessary to make the robot drive at that speed going roughly that distance.
