...
def main():
    ...
    root.bind('<spcae>', lambda event: stop(mqtt_client, left_speed_entry, right_speed_entry))
    ...
    back_button['command'] = lambda: down(mqtt_client, left_speed_entry, right_speed_entry)
    root.bind('<Down>', lambda event: down(mqtt_client, left_speed_entry, right_speed_entry))
...
def down(mqtt_client):
    print("down")
    mqtt_client.send_message("move_down")


def left(mqtt_client):
    print("left")
    mqtt_client.send_message("move_left")
...
def right(mqtt_client):
    print("right")
    mqtt_client.send_message("move_right")
