...
def main():
    ...
    my_name = "Tyler Foster"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Ryan Taylor"  # Used to set the topic that you will *publish to*
